...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDLIBRARY': '',
 'BLDSHARED': '/usr/bin/clang -bundle -undefined dynamic_lookup -L/opt/local/lib -Wl,-headerpad_max_install_names -L/opt/local/lib/db46 ',
 'BUILDEXE': '.exe',
 ...
 'CONFIG_ARGS': "'--prefix=/opt/local' '--enable-framework=/opt/local/Library/Frameworks' '--enable-ipv6' 'CC=/usr/bin/clang' 'CFLAGS=-pipe -Os -fwrapv ' 'LDFLAGS=-L/opt/local/lib -Wl,-headerpad_max_install_names -L/opt/local/lib/db46 ' 'CPPFLAGS=-I/opt/local/include -I/opt/local/include/db46'",
 ...
 'CPPFLAGS': '-I. -IInclude -I./Include -I/opt/local/include -I/opt/local/include/db46',
 'CXX': '/usr/bin/clang++',
 'C_THREADS': 0,
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-fno-strict-aliasing -fno-common -dynamic -pipe -Os -fwrapv  -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -I. -IInclude -I./Include -I/opt/local/include -I/opt/local/include/db46  -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/opt/local/var/macports/build/_opt_mports_dports_lang_python27/python27/work/Python-2.7.6:',
 ...
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/opt/local/var/macports/build/_opt_mports_dports_lang_python27/python27/work/Python-2.7.6: ./python.exe -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/opt/local/var/macports/build/_opt_mports_dports_lang_python27/python27/work/Python-2.7.6',
 'abs_srcdir': '/opt/local/var/macports/build/_opt_mports_dports_lang_python27/python27/work/Python-2.7.6',

...
TCL_EXTRA_CFLAGS='-pipe -Os  -pipe -fvisibility=hidden   '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/local/var/macports/build/_opt_mports_dports_lang_tcl/tcl/work/tcl8.6.1/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/local/lib -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/opt/local/var/macports/build/_opt_mports_dports_lang_tcl/tcl/work/tcl8.6.1'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/local/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/local/var/macports/build/_opt_mports_dports_lang_tcl/tcl/work/tcl8.6.1/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/opt/local/var/macports/build/_opt_mports_dports_lang_tcl/tcl/work/tcl8.6.1/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/local/lib/libtclstub8.6.a'

...
tie %Config, 'Config', {
    archlibexp => '/opt/local/lib/perl5/5.16.1/darwin-thread-multi-2level',
    ...
    exe_ext => '',
    inc_version_list => '5.16.0/darwin-thread-multi-2level 5.16.0 ',
    intsize => '4',
    ...
    osvers => '12.3.0',
    path_sep => ':',
    privlibexp => '/opt/local/lib/perl5/5.16.1',

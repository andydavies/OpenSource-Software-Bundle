...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/appurify/.rvm/rubies/ruby-2.1.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/appurify/.rvm/rubies/ruby-2.1.1' '--with-opt-dir=/opt/local' '--without-tcl' '--without-tk' '--enable-shared' 'CC=/usr/bin/clang'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/appurify/.rvm/rubies/ruby-2.1.1"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress -L/opt/local/lib "
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -I/opt/local/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector -L/usr/local/lib -L/opt/local/lib "
